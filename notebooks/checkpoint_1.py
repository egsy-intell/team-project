...
def _(mo):
    ...
    * Other geographic or landscape summaries around the sampling location
    ...
    It can provide:
    * Additional PFAS concentration observations
    * Broader coverage of public water systems
    * A comparison with the PFAS distributions found in the USGS study
    * Information about whether geographic patterns found in the USGS data also appear in another federal dataset
    * A way to discuss the generalizability of the model
