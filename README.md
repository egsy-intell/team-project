...
- **Yaisiel (Yai) Torres** — Claude Code (Anthropic's agentic CLI/IDE
  ...
  [`docs/ai/ytorresv.html`](https://egsy-intell.github.io/team-project/ai/ytorresv.html) (35 threads, 79
